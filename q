...
# model parameters
TOKEN_LIMIT = 1024           # default token limit
LONG_TOKEN_LIMIT = 4096      # token limiit for long response generation
...
def main(args):
    ...
    help_text = f'q ({VERSION}) is an LLM-powered programming copilot from the comfort of your command line.'
